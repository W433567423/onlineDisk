		...
		<view class="p-3 flex align-center">
			...
			<view class="flex-1 flex flex-column text-muted">
				<view class="flex align-end font-sm">
					<text class="font-lg text-dark m-2">涂涂</text>
					男 湖北 20 岁
				</view>
				<span class="text-ellipsis" style="font-weight:initial;font-size: 10rpx;font-style: italic; ">一名平平无奇的大学生</span>
			</view>
		</view>
		<separate-line></separate-line>
		<view class="p-3">
			<progress percent="25" active stroke-width="3" class="mb-3" />
			<view class="flex align-center justify-between">
				<text class="text-light-muted font">总:10TB</text>
				<text>已用:805GB</text>
			</view>
		</view>
		<separate-line></separate-line>
